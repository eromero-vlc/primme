...
PRIMME_NUM primme_dot(PRIMME_NUM *x, PRIMME_NUM *y, primme_params *primme);
PRIMME_NUM primme_svds_dot(PRIMME_NUM *x, PRIMME_NUM *y, int trans, primme_svds_params *primme);
double primme_ddot(PRIMME_NUM *x, PRIMME_NUM *y, primme_params *primme);
void primme_copy(int n, PRIMME_NUM *x, PRIMME_NUM *y);
