...
>>>>>>> master
   ...
   while (!converged &&
      ...
      update_projection_dprimme(V, primme->nLocal, W, primme->nLocal, H,
      ...
      if (primme->locking) {
         ...
         if (primme->maxMatvecs == -1) {
            ...
            Num_dcopy_dprimme(primme->nLocal*primme->minRestartSize, V, 1, &evecs[primme->nLocal*(primme->initSize+primme->numOrthoConst)], 1);
         }
